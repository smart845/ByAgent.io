  ...
  switch (title) {
    ...
    case 'Топ рост/падение':
      content = `
        ...
        <div class="seg" id="moversSeg" style="margin-top:10px;">
          <button class="active" data-dir="gainers" style="flex:0 1 auto;"><span style="font-size:16px;">🚀</span> Топ растущие</button>
          <button data-dir="losers" style="flex:0 1 auto;"><span style="font-size:16px;">🪂</span> Топ падающие</button>
        </div>
        <div id="moversContent" class="mini mono" style="margin-top:10px;">Загрузка...</div>
      `;
      // We need to render the component after the drawer is shown.
      // The main.js calls generateDrawerContent and then adds the 'show' class.
      // We will add a setTimeout in main.js to handle the rendering and button listeners.
      break;
    case 'Листинги':
